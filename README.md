...
Well established patterns from the industry, shipped fast with AI assistance. I wired 23 domain-specific skills (tRPC, Drizzle, BetterAuth, shadcn, AI SDK...), MCPs, and spec-driven workflows into Claude Code so the tooling has real context about the project — not just code completion.
